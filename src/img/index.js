...
export { default as profitRadar } from './profitRadar.avif'
export { default as pup } from './pup.png'
...
export { default as nodeJS } from './node.jpg'
export { default as material } from './materialUI.png'
